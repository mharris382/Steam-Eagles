...
namespace GasSim
{
    public abstract class GasIO : MonoBehaviour
    {
        ...
        public Grid GasGrid
        {
            get
            {
                if (_gasGrid == null)
                {
                    _gasGrid = GetComponentInParent<Grid>();
                    if (_gasGrid == null)
                    {
                        _gasGrid = GlobalGasGrid.Instance.Grid;
                    }
                }
                return _gasGrid ? _gasGrid : _gasGrid = GetComponentInParent<Grid>();
            }
        }
    ...
    public class GasSource : MonoBehaviour, IGasSource
    {
