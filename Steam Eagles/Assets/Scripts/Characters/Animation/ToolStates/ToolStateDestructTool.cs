...
namespace Characters.Animations
{
    ...
    {
        public ToolStateDestructTool(CharacterState characterState, ToolState characterToolState, SkeletonAnimation skeletonAnimation, SkinController skinController, 
