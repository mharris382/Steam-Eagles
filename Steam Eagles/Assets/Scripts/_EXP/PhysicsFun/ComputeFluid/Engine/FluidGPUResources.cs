...
public class FluidGPUResources
{
    ...
    private Vector2Int simulation_dimensions;                 // The resolution of the simulation grid. This is recieved from the fluid simulator
    ...
    {
        simulation_dimensions = new Vector2Int(256, 256);
    ...
    public void Create()
    {
        int xThreads = simulation_dimensions.x / 16;
        int yThreads = simulation_dimensions.y / 16;
        simulation_dimensions = new Vector2Int(xThreads * 16, yThreads * 16);
        velocity_buffer                   = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        dye_buffer                        = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        divergence_buffer                 = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        pressure_buffer                   = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        buffer_pong                       = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        buffer_ping                       = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        ...
        boundary_velocity_offset_buffer   = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        boundary_pressure_offset_buffer   = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
        boundary_dye_offset_buffer        = new ComputeBuffer(simulation_dimensions.x * simulation_dimensions.y, sizeof(float) * 4);
