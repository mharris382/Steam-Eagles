    ...
    public static class ArbitaryBoundaryLUTGenerator
    {
        public static List<int4> GetVelocityLUT()
        {
            ...
            List<int4> CardinalDirectionLUT = new List<int4>
            {
                ...
                new int4(0, 0, 1,
                    1), // in Binary 00111 . In HEX 0x0007   .   3 Neighbours boundary: East, North and West
                ...
                new int4(0, 0, 1,
                    1), // in Binary 01011 . In HEX 0x000B   .   3 Neighbours boundary: East, North and South
                new int4(0, 0, 1, 1), // in Binary 01100 . In HEX 0x000C   .   2 Neighbours boundary: West and South
                new int4(0, 0, 1,
                    1), // in Binary 01101 . In HEX 0x000D   .   3 Neighbours boundary: East, West and South
                new int4(0, 0, 1,
                    1), // in Binary 01110 . In HEX 0x000E   .   3 Neighbours boundary: North, West and South
                new int4(0, 0, 0,
                    0), // in Binary 01111 . In HEX 0x000F   .   4 Neighbours boundary: East, North, West and South  > We can zero everything here, because this is baisicly a closed space within our closed system
                // All starting with one, the centeral Field is in obstcle 
                new int4(0, 0, -1,
                    -1), // in Binary 10000 . In HEX 0x0010   .   No neighbour is boundary > Ignore this kind of, it is a single floating pixel, should never happen
                ...
                new int4(0, -1, -1,
                    -1), // in Binary 10111 . In HEX 0x0017   .   3 Neighbours boundary: East, North and West
                ...
                new int4(-1, 0, -1,
                    -1), // in Binary 11011 . In HEX 0x001B   .   3 Neighbours boundary: East, North and South
                new int4(1, 1, -1, -1), // in Binary 11100 . In HEX 0x001C   .   2 Neighbours boundary: West and South
                new int4(0, 1, -1,
                    -1), // in Binary 11101 . In HEX 0x001D   .   3 Neighbours boundary: East, West and South
                new int4(1, 0, -1,
                    -1), // in Binary 11110 . In HEX 0x001E   .   3 Neighbours boundary: North, West and South
                new int4(0, 0, 0,
                    0) // in Binary 11111 . In HEX 0x001F   .   4 Neighbours boundary: East, North, West and South
            };
        ...
        public static List<int4> GetPressureLUT()
        {
            ...
            List<int4> CardinalDirectionLUT = new List<int4>
            {
                ...
                new int4(-1, 0, -1,
                    0), // in Binary 11011 . In HEX 0x001B   .   3 Neighbours boundary: East, North and South
                new int4(1, 0, 0, 1), // in Binary 11100 . In HEX 0x001C   .   2 Neighbours boundary: West and South
                new int4(0, 1, 0,
                    1), // in Binary 11101 . In HEX 0x001D   .   3 Neighbours boundary: East, West and South
                new int4(1, 0, 1,
                    0), // in Binary 11110 . In HEX 0x001E   .   3 Neighbours boundary: North, West and South
                new int4(0, 0, 0,
                    0) // in Binary 11111 . In HEX 0x001F   .   4 Neighbours boundary: East, North, West and South
            };
        ...
        public static List<int4> GetDyeLUT()
        {
            List<int4> CardinalDirectionLUT = new List<int4>
            {
                ...
                // All starting with one, the centeral Field is in obstcle 
                new int4(0, 0, 0,
                    0), // in Binary 10000 . In HEX 0x0010   .   No neighbour is boundary > Ignore this kind of, it is a single floating pixel, should never happen
                ...
                new int4(0, 0, 0,
                    0), // in Binary 10111 . In HEX 0x0017   .   3 Neighbours boundary: East, North and West
                ...
                new int4(0, 0, 0,
                    0), // in Binary 11101 . In HEX 0x001D   .   3 Neighbours boundary: East, West and South
                new int4(0, 0, 0,
                    0), // in Binary 11110 . In HEX 0x001E   .   3 Neighbours boundary: North, West and South
                new int4(0, 0, 0,
                    0) // in Binary 11111 . In HEX 0x001F   .   4 Neighbours boundary: East, North, West and South
