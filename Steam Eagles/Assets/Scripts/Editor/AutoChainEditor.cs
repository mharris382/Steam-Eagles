...
namespace Editor
{
    ...
    public class AutoChainEditor : UnityEditor.Editor
    {
        ...
        private void OnSceneGUI()
        {
            ...
            var fmh_35_78_638107055392976603 = Quaternion.identity; Vector3 newStartPosition = Handles.FreeMoveHandle(startPosition, size, Vector3.zero, Handles.SphereHandleCap);
            var fmh_36_74_638107055392993691 = Quaternion.identity; Vector3 newEndPosition = Handles.FreeMoveHandle(endPosition, size, Vector3.zero, Handles.SphereHandleCap);
